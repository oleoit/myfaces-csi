 ...
 * @version $Name:  $ ($Revision: 199 $) $Date: 2008-11-19 10:45:05 +0800 (Wed, 19 Nov 2008) $
 */
public class ColorizedIconParser extends BaseImageProviderRequestParser
{
  ...
  private static final SkinLogger _LOG = SkinLogger.createSkinLogger(ColorizedIconParser.class);
}

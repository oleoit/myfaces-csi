...
/**
   ...
   */
  public static SkinLogger getAnonymousLogger() 
  {
    return new SkinLogger(Logger.getAnonymousLogger());    
  }
   ...
   * @throws MissingResourceException if the named ResourceBundle cannot be found.
   */
  public static SkinLogger getAnonymousLogger(String resourceBundleName) 
  {
    return new SkinLogger(Logger.getAnonymousLogger(resourceBundleName));
  }
  ...
  public void log(Level level, String msg) 
  {
    if (isLoggable(level))
    {
      SkinLogRecord lr = new SkinLogRecord(level, msg);
      doLog(lr);  
    }
  }

...
public final class Coercions
{
                              ...
                              Class<?> type) throws IllegalArgumentException
  {
    if (type != null)
    {
      ...
      // SKINFIX: Avoid hard dependence, doing the same by reflection
      //else if (type == Style.class)
      else if (type.getName().equals("org.apache.myfaces.trinidadinternal.style.Style"))
      {
          try 
          {
              Class<?> cssutils = Class.forName("org.apache.myfaces.trinidadinternal.style.util.CSSUtils");
              Class [] signature = {String.class};   
              Method m = cssutils.getDeclaredMethod("parseStyle",  signature);
              Object [] params = {text};
              return m.invoke(cssutils, params);
              // SKINFIX:
          ...
          {
              throw new IllegalArgumentException(_LOG.getMessage(
                      "CANNOT_FIND_CLASS", "org.apache.myfaces.trinidadinternal.style.util.CSSUtils"));                  
          }
          catch (NoSuchMethodException e)
          {
              throw new IllegalArgumentException(_LOG.getMessage(
                      "NO_METHODCANNOT_FIND_CLASS", "org.apache.myfaces.trinidadinternal.style.util.CSSUtils: No method"));                 
          }
          catch (InvocationTargetException e)
          {
              throw new IllegalArgumentException(_LOG.getMessage(
                      "NO_METHODCANNOT_FIND_CLASS", "org.apache.myfaces.trinidadinternal.style.util.CSSUtils: Invocation error"));                 
          }
          catch (IllegalAccessException e)
          {
              throw new IllegalArgumentException(_LOG.getMessage(
                      "NO_METHODCANNOT_FIND_CLASS", "org.apache.myfaces.trinidadinternal.style.util.CSSUtils: Illegal Access"));                 
          }              

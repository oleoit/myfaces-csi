 ...
 * 
 */
abstract public class SkinRequestContextFactory
{
  /**
   * Retrieve the current RequestContextFactory.
   */
  static public SkinRequestContextFactory getFactory()
  {
   ...
   */
  static public void setFactory(SkinRequestContextFactory factory)
  {
    synchronized (_FACTORIES)
    {
   ...
   */
  abstract public SkinRequestContext createContext(ExternalContext ec);
  ...
  static private final Map<ClassLoader, SkinRequestContextFactory> _FACTORIES = 
    new WeakHashMap<ClassLoader, SkinRequestContextFactory>();
  private static final TrinidadLogger _LOG = TrinidadLogger.createTrinidadLogger(
    SkinRequestContextFactory.class);
}

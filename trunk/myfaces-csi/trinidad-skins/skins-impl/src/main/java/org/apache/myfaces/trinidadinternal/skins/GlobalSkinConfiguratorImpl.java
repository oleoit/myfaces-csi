...
public class GlobalSkinConfiguratorImpl extends Configurator
{
     ...
     */
    static public final GlobalSkinConfiguratorImpl getInstance()
    {
    ...
    static private final Map<ClassLoader, GlobalSkinConfiguratorImpl> _CONFIGURATORS = new HashMap<ClassLoader, GlobalSkinConfiguratorImpl>();
    static private final String _IN_REQUEST    = GlobalSkinConfiguratorImpl.class
                                                           .getName()
                                                           + ".IN_REQUEST";
    static private final String _REQUEST_CONTEXT = GlobalSkinConfiguratorImpl.class.getName()
                                                           +".REQUEST_CONTEXT";
    static private final TrinidadLogger _LOG  = TrinidadLogger.createTrinidadLogger(GlobalSkinConfiguratorImpl.class);
    ...
    private enum RequestType
    {
      ...
      static private final String _REQUEST_TYPE = GlobalSkinConfiguratorImpl.class.getName()
                                                    + ".REQUEST_TYPE";
    }
}

 ...
 */
  ...
  */
    ...
    String       outputMode)
  {
    ...
    if (XhtmlConstants.OUTPUT_MODE_PRINTABLE.equals(outputMode))
    {
      return AgentUtil.mergeCapabilities(agent, _PRINTABLE_CAPABILITIES);
    }
    else if (XhtmlConstants.OUTPUT_MODE_EMAIL.equals(outputMode))
    {
      return AgentUtil.mergeCapabilities(agent, _EMAIL_CAPABILITIES);
    }
    else if (XhtmlConstants.OUTPUT_MODE_PORTLET.equals(outputMode))
    {

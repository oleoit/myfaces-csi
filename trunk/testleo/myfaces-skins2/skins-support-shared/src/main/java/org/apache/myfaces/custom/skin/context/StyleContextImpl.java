...
import org.apache.myfaces.custom.skin.provider.SkinStyleProvider;
...
class StyleContextImpl implements StyleContext
{
  ...
  {
      // SKINFIX: use SkinableRenderingContext interface
    return ((SkinableRenderingContext) _arc).getTrinidadAgent();
  }
  ...
  {
    return XhtmlConstants.OUTPUT_MODE_PORTLET.equals(_arc.getOutputMode());
  }

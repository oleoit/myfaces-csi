...
public class ThreadLocalResetter extends ThreadLocalLifecycle
{
    ...
    public void init(ThreadLocalManager manager)
    {
        ...
        SkinConfiguratorImpl.getInstance().__setThreadLocalResetter(this);
    }
    ...
    private AtomicReference<ThreadLocalManager> _threadLocalManager = new AtomicReference<ThreadLocalManager>();
}

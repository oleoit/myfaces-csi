...
public class CoreSkinRenderingContext extends SkinRenderingContext
{
    /**
    ...
    public Skin getRequestMapSkin()
    {
        ...
        if (XhtmlConstants.OUTPUT_MODE_PORTLET.equals(getOutputMode()))
        {
            FacesContext context = FacesContext.getCurrentInstance();
            ...
            if (requestedSkinId != null)
            {
                ...
                Skin requestedSkin = factory.getSkin(context, requestedSkinId
                        .toString());
                if (requestedSkin != null)
                {
                    ...
                    Object requestMapStyleSheetId = requestMap
                            .get(_SKIN_STYLESHEET_ID_PARAM);
                    if (requestMapStyleSheetId != null)
                    {
                        String skinForPortalStyleSheetId = requestedSkin
                                .getStyleSheetDocumentId(this);
                        if (skinForPortalStyleSheetId != null
                                && skinForPortalStyleSheetId
                                        .equals(requestMapStyleSheetId))
                        {
    ...
    private void _initializeSkin(FacesContext context, SkinRequestContext afContext)
    {
        // get skinFamily
    ...
    private TrinidadAgent _initializeAgent(FacesContext context, Agent base,
            String outputMode)
    {
        ...
        if (OUTPUT_MODE_PRINTABLE.equals(outputMode))
        {
            return AgentUtil.mergeCapabilities(agent, _PRINTABLE_CAPABILITIES);
        }
        else if (OUTPUT_MODE_EMAIL.equals(outputMode))
        {
            return AgentUtil.mergeCapabilities(agent, _EMAIL_CAPABILITIES);
        }
        else if (OUTPUT_MODE_PORTLET.equals(outputMode))
        {
    ...
    static public String getTemporaryDirectory(FacesContext fContext)
    {
        ...
        if (applicationMap != null)
        {
            ...
            if (tempdir == null)
            {
                ...
                {
                    _LOG
                            .severe("The java.io.File handle (\"javax.servlet.context.tempdir\") is not set in the ServletContext");
                }
            }
            else
            {
    ...
    private void _initializeLocaleContext(FacesContext fContext,
            SkinRequestContext context)
    {
        ...
        localeContext
                .setReadingDirection(context.isRightToLeft() ? LocaleUtils.DIRECTION_RIGHTTOLEFT
                        : LocaleUtils.DIRECTION_LEFTTORIGHT);
        localeContext.setTimeZone(context.getTimeZone());

        MutableDecimalFormatContext mdfc = new MutableDecimalFormatContext(
                localeContext.getDecimalFormatContext());
    ...
    static private final String _SKIN_ID_PARAM = "org.apache.myfaces.trinidad.skin.id";
    static private final String _SKIN_STYLESHEET_ID_PARAM = "org.apache.myfaces.trinidad.skin.stylesheet.id";
    ...
    static private final Map<Object, Object> _PRINTABLE_CAPABILITIES = new HashMap<Object, Object>();

    static private final Map<Object, Object> _EMAIL_CAPABILITIES = new HashMap<Object, Object>();

    static private final Map<Object, Object> _PORTLET_CAPABILITIES = new HashMap<Object, Object>();
    ...
    static
    {
        ...
        _PRINTABLE_CAPABILITIES
                .put(TrinidadAgent.CAP_NAVIGATION, Boolean.FALSE);
    ...
    static private final TrinidadLogger _LOG = TrinidadLogger
            .createTrinidadLogger(CoreSkinRenderingContext.class);

...
import org.apache.myfaces.trinidadinternal.skins.CoreSkinRenderingContext;
...
public class StyleContextImpl implements StyleContext
{
  ...
  public StyleProvider getStyleProvider()
  {
    if (_styleProvider == null)
      _styleProvider = _getDefaultStyleProvider(((SkinRenderingContext) _arc).getSkin());
  ...
  {
    return ((CoreSkinRenderingContext) _arc).getTrinidadAgent();
  }
